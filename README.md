...
Npcap segítségével elfogja a Zwift UDP csomagjait (port 3024), dekódolja a protobuf üzeneteket, és azonnali teljesítmény/pulzus/kadencia/sebesség adatokat küld UDP-n keresztül (127.0.0.1:7878).
...
- **Zwift bejelentkezési adatok** (`ZWIFT_USERNAME` / `ZWIFT_PASSWORD` env változók, CLI flagek, vagy interaktív prompt)
...
Capturing on \Device\NPF_{...} – BPF: udp port 3024
...
✅ Rider ID: 123456
🔄 Lekérdezési intervallum / Poll interval: 1.0s
Press Ctrl+C to stop.
...
- Ellenőrizd, hogy a tűzfal nem blokkolja-e az UDP 3024-es portot.
